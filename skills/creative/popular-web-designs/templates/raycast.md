...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `raycast/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/raycast.md")`.
> Inter is open-source. Enable `font-feature-settings: 'calt', 'kern', 'liga', 'ss03'` to preserve Raycast's signature alternate `g`. JetBrains Mono for code.
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | Inter ("calt", "kern", "liga", "ss03") | 64px | 600 | 1.1 | 0 |
| `display-lg` | Inter ("calt", "kern", "liga", "ss03") | 56px | 500 | 1.17 | 0.2px |
| `heading-xl` | Inter ("calt", "kern", "liga", "ss03") | 24px | 500 | 1.6 | 0.2px |
| `heading-lg` | Inter ("calt", "kern", "liga", "ss03") | 22px | 500 | 1.15 | 0 |
| `heading-md` | Inter ("calt", "kern", "liga", "ss03") | 20px | 500 | 1.4 | 0.2px |
| `heading-sm` | Inter ("calt", "kern", "liga", "ss03") | 18px | 500 | 1.4 | 0.2px |
| `body-lg` | Inter ("calt", "kern", "liga", "ss03") | 18px | 400 | 1.6 | 0 |
| `body-md` | Inter ("calt", "kern", "liga", "ss03") | 16px | 400 | 1.6 | 0 |
| `body-strong` | Inter ("calt", "kern", "liga", "ss03") | 16px | 500 | 1.4 | 0.2px |
| `body-sm` | Inter ("calt", "kern", "liga", "ss03") | 14px | 400 | 1.6 | 0 |
| `body-sm-strong` | Inter ("calt", "kern", "liga", "ss03") | 14px | 500 | 1.6 | 0.2px |
| `caption-md` | Inter ("calt", "kern", "liga", "ss03") | 13px | 400 | 1.4 | 0.1px |
| `caption-sm` | Inter ("calt", "kern", "liga", "ss03") | 12px | 400 | 1.5 | 0.4px |
| `link-md` | Inter ("calt", "kern", "liga", "ss03") | 16px | 500 | 1.4 | 0.3px |
| `button-md` | Inter ("calt", "kern", "liga", "ss03") | 14px | 500 | 1.6 | 0.2px |
