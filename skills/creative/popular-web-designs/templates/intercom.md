...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `intercom/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/intercom.md")`.
> Saans is proprietary; Inter at weight 500 is the closest free substitute. SaansMono fallback: JetBrains Mono.
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | Saans | 72px | 500 | 1.05 | -2.0px |
| `display-lg` | Saans | 56px | 500 | 1.1 | -1.4px |
| `display-md` | Saans | 40px | 500 | 1.15 | -0.8px |
| `headline` | Saans | 28px | 500 | 1.2 | -0.5px |
| `card-title` | Saans | 22px | 500 | 1.25 | -0.3px |
| `subhead` | Saans | 20px | 400 | 1.4 | -0.2px |
| `body-lg` | Saans | 18px | 400 | 1.5 | -0.1px |
| `body` | Saans | 16px | 400 | 1.5 | 0 |
| `body-sm` | Saans | 14px | 400 | 1.5 | 0 |
| `caption` | Saans | 12px | 400 | 1.4 | 0 |
| `button` | Saans | 15px | 500 | 1.2 | 0 |
| `eyebrow` | Saans | 14px | 500 | 1.3 | 0 |
| `mono` | SaansMono | 13px | 400 | 1.5 | 0 |
