...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `nintendo-2001/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/nintendo-2001.md")`.
> Original site used Arial / Arial Black. Roboto is a neutral system-friendly Google substitute; keep Arial as a final fallback for the retro look.
...
|-------|------|------|--------|-------------|----------------|
| `nav-link` | Arial | 13px | 700 | 1 | 0.5px |
| `ui-label` | Arial | 11px | 700 | 1.1 | 0.5px |
| `display` | Arial Black | 44px | 900 | 1 | 0 |
| `hero-tagline` | Arial | 15px | 700 | 1.3 | 0 |
| `body` | Arial | 12px | 400 | 1.4 | 0 |
| `link` | Arial | 12px | 700 | 1.4 | 0 |
| `micro` | Arial | 10px | 400 | 1.3 | 0 |
...
- Scale typography tokens down on tablet/mobile while keeping weights and colours consistent.
- Convert multi-column grids to single-column on narrow viewports.
- Preserve touch-target sizes and accessible contrast.
