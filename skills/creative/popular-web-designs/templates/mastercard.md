...
>
> The original site uses proprietary fonts. MarkForMC is proprietary; Sofia Sans is the documented open-source fallback.
> For self-contained HTML output, use these CDN substitutes:
> - **Primary:** `Sofia Sans` | **Mono:** `Source Code Pro`
> - **Font stack (CSS):** `font-family: 'Sofia Sans', system-ui, -apple-system, BlinkMacSystemFont, sans-serif;`
> - **Mono stack (CSS):** `font-family: 'Source Code Pro', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;`
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:wght@300;400;500;600;700&display=swap&family=Source+Code+Pro:wght@400;500;700&display=swap" rel="stylesheet">
> ```
