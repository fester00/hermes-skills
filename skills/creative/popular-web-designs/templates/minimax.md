...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `minimax/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/minimax.md")`.
> DM Sans is open-source on Google Fonts and matches the documented system exactly.
> - **Primary:** `DM Sans` | **Font stack (CSS):** `font-family: 'DM Sans', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
> ```html
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | DM Sans | 80px | 600 | 1.1 | -2px |
| `display-lg` | DM Sans | 56px | 600 | 1.1 | -1.5px |
| `heading-lg` | DM Sans | 40px | 600 | 1.2 | -1px |
| `heading-md` | DM Sans | 32px | 600 | 1.25 | -0.5px |
| `heading-sm` | DM Sans | 24px | 600 | 1.3 | — |
| `card-title` | DM Sans | 20px | 600 | 1.4 | — |
| `subtitle` | DM Sans | 18px | 500 | 1.5 | — |
| `body-md` | DM Sans | 16px | 400 | 1.5 | — |
| `body-md-bold` | DM Sans | 16px | 700 | 1.5 | — |
| `body-sm` | DM Sans | 14px | 400 | 1.5 | — |
| `body-sm-medium` | DM Sans | 14px | 500 | 1.5 | — |
| `caption` | DM Sans | 13px | 400 | 1.7 | — |
| `caption-bold` | DM Sans | 13px | 600 | 1.5 | — |
| `micro` | DM Sans | 12px | 400 | 1.5 | — |
| `button-md` | DM Sans | 14px | 600 | 1.4 | — |
