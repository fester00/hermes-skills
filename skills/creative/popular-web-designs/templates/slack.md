...
>
> The original site uses proprietary fonts. Salesforce Avant Garde / Salesforce Sans are proprietary; Inter is the closest open substitute.
> For self-contained HTML output, use these CDN substitutes:
> - **Primary:** `Inter` | **Mono:** `Source Code Pro`
> - **Font stack (CSS):** `font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, sans-serif;`
> - **Mono stack (CSS):** `font-family: 'Source Code Pro', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;`
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap&family=Source+Code+Pro:wght@400;500;700&display=swap" rel="stylesheet">
> ```
...
|-------|------|------|--------|-------------|----------------|
| `display-xxl` | Salesforce-Avant-Garde | 64px | 700 | 1.12 | -0.768px |
| `display-xl` | Salesforce-Avant-Garde | 58px | 600 | 1.25 | -0.464px |
| `display-lg` | Salesforce-Avant-Garde | 50px | 700 | 1.12 | -0.6px |
| `display-md` | Salesforce-Avant-Garde | 32px | 700 | 1.25 | -0.256px |
| `heading-lg` | Salesforce-Avant-Garde | 24px | 700 | 1.33 | -0.096px |
| `heading-md` | Salesforce-Avant-Garde | 22px | 600 | 1.4 | 0 |
| `heading-sm` | Salesforce-Avant-Garde | 18px | 600 | 1.56 | -0.0216px |
| `body-lg` | Salesforce-Sans | 18px | 400 | 1.55 | -0.0216px |
| `body-md` | Salesforce-Sans | 16px | 400 | 1.55 | 0 |
| `body-strong` | Salesforce-Sans | 16px | 700 | 1.5 | 0.16px |
| `button-lg` | Salesforce-Sans | 18px | 700 | 1.0 | 0 |
| `button-md` | Salesforce-Sans | 16px | 700 | 1.38 | 0.2px |
| `button-cap` | Salesforce-Sans | 14.4px | 700 | 1.0 | 0.144px |
| `caption` | Salesforce-Sans | 14px | 400 | 1.43 | 0.1px |
| `micro-cap` | Salesforce-Sans | 12px | 700 | 1.0 | 0.96px |
