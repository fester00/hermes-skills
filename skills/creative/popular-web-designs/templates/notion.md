...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `notion/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/notion.md")`.
> Notion Sans is Inter-based; use Inter weights 400-700.
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | Notion Sans | 80px | 600 | 1.05 | -2px |
| `display-lg` | Notion Sans | 56px | 600 | 1.1 | -1px |
| `heading-1` | Notion Sans | 48px | 600 | 1.15 | -0.5px |
| `heading-2` | Notion Sans | 36px | 600 | 1.2 | -0.5px |
| `heading-3` | Notion Sans | 28px | 600 | 1.25 | — |
| `heading-4` | Notion Sans | 22px | 600 | 1.3 | — |
| `heading-5` | Notion Sans | 18px | 600 | 1.4 | — |
| `subtitle` | Notion Sans | 18px | 400 | 1.5 | — |
| `body-md` | Notion Sans | 16px | 400 | 1.55 | — |
| `body-md-medium` | Notion Sans | 16px | 500 | 1.55 | — |
| `body-sm` | Notion Sans | 14px | 400 | 1.5 | — |
| `body-sm-medium` | Notion Sans | 14px | 500 | 1.5 | — |
| `caption` | Notion Sans | 13px | 400 | 1.4 | — |
| `caption-bold` | Notion Sans | 13px | 600 | 1.4 | — |
| `micro` | Notion Sans | 12px | 500 | 1.4 | — |
| `micro-uppercase` | Notion Sans | 11px | 600 | 1.4 | 1px |
| `button-md` | Notion Sans | 14px | 500 | 1.3 | — |
