...
>
> The original site uses proprietary fonts. Manuka is proprietary and tightly metric; use Anton/Oswald/Bebas Neue for display and Space Mono for uppercase labels.
> For self-contained HTML output, use these CDN substitutes:
> - **Primary:** `Anton` | **Mono:** `Space Mono`
> - **Font stack (CSS):** `font-family: 'Anton', system-ui, -apple-system, BlinkMacSystemFont, sans-serif;`
> - **Mono stack (CSS):** `font-family: 'Space Mono', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;`
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Anton:wght@300;400;500;600;700&display=swap&family=Space+Mono:wght@400;500;700&display=swap" rel="stylesheet">
> ```
