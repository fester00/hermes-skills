...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `meta/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/meta.md")`.
> Optimistic VF is proprietary; Montserrat is the documented fallback. Enable ss01/ss02 via stylistic sets if the chosen face supports them.
> - **Primary:** `Montserrat` | **Font stack (CSS):** `font-family: 'Montserrat', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
> ```html
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | Optimistic VF (ss01, ss02) | 64px | 500 | 1.16 | — |
| `display-lg` | Optimistic VF (ss01, ss02) | 48px | 500 | 1.17 | — |
| `heading-lg` | Optimistic VF (ss01, ss02) | 36px | 500 | 1.28 | — |
| `heading-md` | Optimistic VF (ss01, ss02) | 28px | 300 | 1.21 | — |
| `heading-sm` | Optimistic VF (ss01, ss02) | 24px | 500 | 1.25 | — |
| `subtitle-lg` | Optimistic VF | 18px | 700 | 1.44 | — |
| `subtitle-md` | Optimistic VF | 18px | 400 | 1.44 | — |
| `body-md-bold` | Optimistic VF | 16px | 700 | 1.5 | -0.16px |
| `body-md` | Optimistic VF | 16px | 400 | 1.5 | -0.16px |
| `body-sm-bold` | Optimistic VF | 14px | 700 | 1.43 | -0.14px |
| `body-sm` | Optimistic VF | 14px | 400 | 1.43 | -0.14px |
| `caption-bold` | Optimistic VF | 12px | 700 | 1.33 | — |
| `caption` | Optimistic VF | 12px | 400 | 1.33 | — |
| `button-md` | Optimistic VF | 14px | 700 | 1.43 | -0.14px |
| `link-md` | Optimistic VF | 16px | 700 | 1.5 | -0.16px |
