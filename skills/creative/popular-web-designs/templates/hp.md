...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `hp/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/hp.md")`.
> Forma DJR Micro is proprietary. Use Space Grotesk (Google Fonts) as the closest free geometric display sans.
...
|-------|------|------|--------|-------------|----------------|
| `display-xxl` | Forma DJR Micro | 72px | 500 | 1.0 | 0 |
| `display-xl` | Forma DJR Micro | 56px | 500 | 1.0 | 0 |
| `display-lg` | Forma DJR Micro | 44px | 500 | 1.0 | 0 |
| `display-md` | Forma DJR Micro | 32px | 500 | 1.0 | 0 |
| `display-sm` | Forma DJR Micro | 24px | 500 | 1.17 | 0 |
| `display-xs` | Forma DJR Micro | 20px | 500 | 1.0 | 0 |
| `body-lg` | Forma DJR Micro | 18px | 400 | 1.33 | 0 |
| `body-md` | Forma DJR Micro | 16px | 400 | 1.38 | 0 |
| `body-emphasis` | Forma DJR Micro | 16px | 500 | 1.38 | 0 |
| `caption-md` | Forma DJR Micro | 14px | 400 | 1.5 | 0 |
| `caption-sm` | Forma DJR Micro | 12px | 400 | 1.33 | 0 |
| `caption-bold` | Forma DJR Micro | 14px | 700 | 1.3 | 0 |
| `link-md` | Forma DJR Micro | 16px | 500 | 1.38 | 0 |
| `button-md` | Forma DJR Micro (uppercase) | 14px | 600 | 1.4 | 0.7px |
| `button-sm` | Forma DJR Micro | 12.6px | 700 | 1.0 | 0.126px |
| `price-md` | Forma DJR Micro | 24px | 500 | 1.17 | 0 |
