...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `mintlify/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/mintlify.md")`.
> Inter for UI prose; JetBrains Mono substitutes Geist Mono for code blocks and inline references.
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | Inter | 72px | 600 | 1.05 | -2px |
| `display-lg` | Inter | 56px | 600 | 1.1 | -1.5px |
| `heading-1` | Inter | 48px | 600 | 1.1 | -1px |
| `heading-2` | Inter | 36px | 600 | 1.2 | -0.5px |
| `heading-3` | Inter | 28px | 600 | 1.25 | — |
| `heading-4` | Inter | 22px | 600 | 1.3 | — |
| `heading-5` | Inter | 18px | 600 | 1.4 | — |
| `subtitle` | Inter | 18px | 400 | 1.5 | — |
| `body-md` | Inter | 16px | 400 | 1.5 | — |
| `body-md-medium` | Inter | 16px | 500 | 1.5 | — |
...
| `micro-uppercase` | Inter | 11px | 600 | 1.4 | 0.5px |
| `button-md` | Inter | 14px | 500 | 1.3 | — |
| `code-md` | Geist Mono | 14px | 400 | 1.5 | — |
| `code-sm` | Geist Mono | 13px | 400 | 1.4 | — |
| `code-inline` | Geist Mono | 13px | 500 | 1.3 | — |
