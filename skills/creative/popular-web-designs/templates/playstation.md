...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `playstation/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/playstation.md")`.
> PlayStation SST is proprietary; Roboto Light (300) matches the display optical fit. Inter is a viable body substitute.
> - **Primary:** `Roboto` | **Font stack (CSS):** `font-family: 'Roboto', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
> ```html
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | PlayStation SST | 54px | 300 | 1.25 | -0.1px |
| `display-lg` | PlayStation SST | 44px | 300 | 1.25 | 0.1px |
| `display-md` | PlayStation SST | 35px | 300 | 1.25 | 0 |
| `heading-xl` | PlayStation SST | 28px | 300 | 1.25 | 0.1px |
| `heading-lg` | PlayStation SST | 22px | 300 | 1.25 | 0.1px |
| `heading-md` | PlayStation SST | 18px | 600 | 1 | 0 |
| `body-md` | PlayStation SST | 18px | 400 | 1.5 | 0.1px |
| `body-strong` | PlayStation SST | 18px | 500 | 1.25 | 0.4px |
| `body-sm` | PlayStation SST | 16px | 400 | 1.5 | 0 |
| `caption-md` | PlayStation SST | 14px | 400 | 1.5 | 0 |
| `caption-sm` | PlayStation SST | 12px | 500 | 1.5 | 0 |
| `link-md` | PlayStation SST | 18px | 400 | 1.5 | 0 |
| `button-lg` | PlayStation SST | 18px | 700 | 1.25 | 0.45px |
| `button-md` | PlayStation SST | 14px | 700 | 1.25 | 0.324px |
