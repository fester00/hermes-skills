...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `opencode.ai/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/opencode.ai.md")`.
> Berkeley Mono is proprietary. JetBrains Mono is the closest free monospace substitute and should be used for every text role.
> - **Primary:** `JetBrains Mono` | **Font stack (CSS):** `font-family: 'JetBrains Mono', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | Berkeley Mono | 38px | 700 | 1.5 | 0 |
| `heading-md` | Berkeley Mono | 16px | 700 | 1.5 | 0 |
| `body-md` | Berkeley Mono | 16px | 400 | 1.5 | 0 |
| `body-strong` | Berkeley Mono | 16px | 500 | 1.5 | 0 |
| `body-tight` | Berkeley Mono | 16px | 500 | 1 | 0 |
| `link-md` | Berkeley Mono | 16px | 400 | 1.5 | 0 |
| `button-md` | Berkeley Mono | 16px | 500 | 2 | 0 |
| `caption-md` | Berkeley Mono | 14px | 400 | 2 | 0 |
