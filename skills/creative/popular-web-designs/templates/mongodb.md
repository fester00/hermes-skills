...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `mongodb/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/mongodb.md")`.
> Euclid Circular A is proprietary; Inter is the closest free geometric substitute. Source Code Pro for code mockups.
> - **Primary:** `Inter` | **Font stack (CSS):** `font-family: 'Inter', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
- **Mono:** `Source Code Pro` | **Mono stack (CSS):** `font-family: 'Source Code Pro', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;`
> ```html
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | Euclid Circular A | 72px | 500 | 1.1 | -1.5px |
| `display-lg` | Euclid Circular A | 56px | 500 | 1.15 | -1px |
| `heading-1` | Euclid Circular A | 48px | 500 | 1.2 | -0.5px |
| `heading-2` | Euclid Circular A | 36px | 500 | 1.25 | -0.5px |
| `heading-3` | Euclid Circular A | 28px | 500 | 1.3 | — |
| `heading-4` | Euclid Circular A | 22px | 500 | 1.35 | — |
| `heading-5` | Euclid Circular A | 18px | 600 | 1.4 | — |
| `subtitle` | Euclid Circular A | 18px | 400 | 1.5 | — |
| `body-md` | Euclid Circular A | 16px | 400 | 1.55 | — |
| `body-md-medium` | Euclid Circular A | 16px | 500 | 1.55 | — |
| `body-sm` | Euclid Circular A | 14px | 400 | 1.5 | — |
| `body-sm-medium` | Euclid Circular A | 14px | 500 | 1.5 | — |
| `caption` | Euclid Circular A | 13px | 400 | 1.4 | — |
| `caption-bold` | Euclid Circular A | 13px | 600 | 1.4 | — |
| `micro` | Euclid Circular A | 12px | 500 | 1.4 | — |
| `micro-uppercase` | Euclid Circular A | 11px | 600 | 1.4 | 1px |
| `button-md` | Euclid Circular A | 14px | 600 | 1.3 | — |
| `code-md` | Source Code Pro | 14px | 400 | 1.55 | — |
