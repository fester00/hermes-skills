...
>
> The original site uses proprietary fonts. WiredDisplay is proprietary; Playfair Display approximates the high-contrast serif.
> For self-contained HTML output, use these CDN substitutes:
> - **Primary:** `Playfair Display` | **Mono:** `Inconsolata`
> - **Font stack (CSS):** `font-family: 'Playfair Display', system-ui, -apple-system, BlinkMacSystemFont, sans-serif;`
> - **Mono stack (CSS):** `font-family: 'Inconsolata', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;`
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@300;400;500;600;700&display=swap&family=Inconsolata:wght@400;500;700&display=swap" rel="stylesheet">
> ```
...
|-------|------|------|--------|-------------|----------------|
| `display-hero` | WiredDisplay | 64px | 400 | 59.52px | -0.5px |
| `display-lg` | WiredDisplay | 48px | 400 | 50.4px | -0.4px |
| `display-md` | WiredDisplay | 32px | 400 | 35.2px | -0.3px |
| `display-sm` | WiredDisplay | 26px | 400 | 28.08px | normal |
| `display-xs` | Apercu | 20px | 700 | 24px | -0.28px |
| `body-serif-lg` | BreveText | 19px | 400 | 27.93px | 0.108px |
| `body-serif-md` | BreveText | 16px | 400 | 24px | 0.09px |
| `body-md` | Apercu | 17px | 400 | 20px | normal |
| `body-md-strong` | Apercu | 17px | 700 | 22px | -0.144px |
| `body-sm` | Apercu | 14px | 400 | 18px | 0.4px |
| `body-sm-strong` | Apercu | 14px | 700 | 18px | 0.4px |
| `byline` | BreveText | 12.73px | 700 | 28px | 0.108px |
| `caption` | Apercu | 12px | 400 | 16px | normal |
| `button-md` | Apercu | 16px | 700 | 20px | 0.3px |
