...
>
> The original site uses proprietary fonts. Neue Haas Grotesk Display is proprietary; Inter Light/300 approximates the thin display weight.
...
|-------|------|------|--------|-------------|----------------|
| `display-xxl` | NeueHaasGrotesk Display | 96px | 330 | 1.0 | 2.4px |
| `display-xl` | NeueHaasGrotesk Display | 70px | 330 | 1.0 | 0 |
| `display-lg` | NeueHaasGrotesk Display | 55px | 330 | 1.16 | 0 |
| `display-md` | NeueHaasGrotesk Display | 48px | 330 | 1.14 | 0 |
| `heading-xl` | NeueHaasGrotesk Display | 28px | 500 | 1.28 | 0.42px |
| `heading-lg` | NeueHaasGrotesk Display | 24px | 400 | 1.14 | 0.36px |
| `heading-md` | NeueHaasGrotesk Display | 20px | 500 | 1.4 | 0.3px |
| `heading-sm` | NeueHaasGrotesk Display | 18px | 500 | 1.25 | 0.72px |
| `body-lg` | Inter Variable | 18px | 550 | 1.56 | 0 |
| `body-md` | Inter Variable | 16px | 420 | 1.5 | 0 |
| `body-strong` | Inter Variable | 16px | 550 | 1.5 | 0 |
| `caption` | Inter Variable | 14px | 500 | 1.49 | 0.28px |
| `micro` | Inter Variable | 13px | 500 | 1.5 | -0.13px |
| `eyebrow-cap` | Inter Variable | 12px | 400 | 1.2 | 0.72px |
| `code` | SFMono-Regular | 16px | 400 | 1.5 | 0 |
