...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `linear.app/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/linear.app.md")`.
> Linear Display/Text/Mono are proprietary. Inter (weights 400-700) is the closest free substitute; Geist Sans is also viable. Use JetBrains Mono for code.
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | Linear Display | 80px | 600 | 1.05 | -3.0px |
| `display-lg` | Linear Display | 56px | 600 | 1.1 | -1.8px |
| `display-md` | Linear Display | 40px | 600 | 1.15 | -1.0px |
| `headline` | Linear Display | 28px | 600 | 1.2 | -0.6px |
| `card-title` | Linear Display | 22px | 500 | 1.25 | -0.4px |
| `subhead` | Linear Display | 20px | 400 | 1.4 | -0.2px |
| `body-lg` | Linear Text | 18px | 400 | 1.5 | -0.1px |
| `body` | Linear Text | 16px | 400 | 1.5 | -0.05px |
| `body-sm` | Linear Text | 14px | 400 | 1.5 | 0 |
| `caption` | Linear Text | 12px | 400 | 1.4 | 0 |
| `button` | Linear Text | 14px | 500 | 1.2 | 0 |
| `eyebrow` | Linear Text | 13px | 500 | 1.3 | 0.4px |
| `mono` | Linear Mono | 13px | 400 | 1.5 | 0 |
