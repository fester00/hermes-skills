...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `ibm/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/ibm.md")`.
> IBM Plex Sans and IBM Plex Mono are open-source on Google Fonts; match the documented Carbon system.
> - **Primary:** `IBM Plex Sans` | **Font stack (CSS):** `font-family: 'IBM Plex Sans', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
- **Mono:** `IBM Plex Mono` | **Mono stack (CSS):** `font-family: 'IBM Plex Mono', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;`
> ```html
...
|-------|------|------|--------|-------------|----------------|
| `display-xl` | IBM Plex Sans | 76px | 300 | 1.17 | -0.5px |
| `display-lg` | IBM Plex Sans | 60px | 300 | 1.17 | -0.4px |
| `display-md` | IBM Plex Sans | 42px | 300 | 1.2 | 0 |
| `headline` | IBM Plex Sans | 32px | 400 | 1.25 | 0 |
| `card-title` | IBM Plex Sans | 24px | 400 | 1.33 | 0 |
| `subhead` | IBM Plex Sans | 20px | 400 | 1.4 | 0 |
| `body-lg` | IBM Plex Sans | 18px | 400 | 1.5 | 0 |
| `body` | IBM Plex Sans | 16px | 400 | 1.5 | 0.16px |
| `body-sm` | IBM Plex Sans | 14px | 400 | 1.29 | 0.16px |
| `body-emphasis` | IBM Plex Sans | 14px | 600 | 1.29 | 0.16px |
| `caption` | IBM Plex Sans | 12px | 400 | 1.33 | 0.32px |
| `button` | IBM Plex Sans | 14px | 400 | 1.29 | 0.16px |
| `eyebrow` | IBM Plex Sans | 14px | 400 | 1.29 | 0.16px |
