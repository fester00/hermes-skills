...
>
> The original site uses proprietary fonts. Vodafone custom display sans is proprietary; Inter Black (800) approximates the heavy uppercase display.
...
|-------|------|------|--------|-------------|----------------|
| `display-hero` | Vodafone | 144px | 800 | 114px | -1px |
| `display-xxl` | Vodafone | 126px | 800 | 113px | -1px |
| `display-xl` | Vodafone | 90px | 800 | 84px | normal |
| `display-lg` | Vodafone | 48px | 300 | 52px | normal |
| `display-md` | Vodafone | 40px | 300 | 44px | normal |
| `display-sm` | Vodafone | 32px | 700 | 40px | normal |
| `display-xs` | Vodafone | 24px | 700 | 24px | normal |
| `eyebrow-uppercase` | Vodafone | 16px | 800 | 24px | normal |
| `body-lg` | Vodafone | 22px | 400 | 24px | normal |
| `body-md` | Vodafone | 18px | 400 | 28px | normal |
| `body-md-strong` | Vodafone | 18px | 600 | 28px | normal |
| `body-sm` | Vodafone | 16px | 400 | 20px | normal |
| `body-sm-strong` | Vodafone | 16px | 700 | 22px | normal |
| `caption` | Vodafone | 14px | 400 | 16px | normal |
| `caption-strong` | Vodafone | 14px | 700 | 21px | normal |
| `caption-uppercase` | Vodafone | 12px | 600 | 16px | 0.5691px |
| `button-md` | Vodafone | 18px | 400 | 28px | normal |
