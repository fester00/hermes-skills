...
>
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) — `mistral.ai/DESIGN.md`
> Use this template with `popular-web-designs` skill. Load via `skill_view(name="popular-web-designs", file_path="templates/mistral.ai.md")`.
> PP Editorial Old is a proprietary near-serif display face; Playfair Display gives a similar elegant editorial voice. Inter for UI, JetBrains Mono for code.
> - **Primary:** `Playfair Display` | **Font stack (CSS):** `font-family: 'Playfair Display', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;`
...
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400,500,600,700&family=Inter:wght@400,500,600,700&family=JetBrains+Mono:wght@400,500&display=swap" rel="stylesheet">
> ```
...
|-------|------|------|--------|-------------|----------------|
| `hero-display` | PP Editorial Old | 84px | 400 | 1.05 | -1.5px |
| `display-lg` | PP Editorial Old | 64px | 400 | 1.1 | -1px |
| `heading-1` | PP Editorial Old | 52px | 400 | 1.15 | -0.5px |
| `heading-2` | Inter | 36px | 500 | 1.2 | -0.5px |
| `heading-3` | Inter | 28px | 500 | 1.25 | — |
| `heading-4` | Inter | 22px | 500 | 1.3 | — |
| `heading-5` | Inter | 18px | 500 | 1.4 | — |
| `subtitle` | Inter | 18px | 400 | 1.5 | — |
| `body-md` | Inter | 16px | 400 | 1.55 | — |
| `body-md-medium` | Inter | 16px | 500 | 1.55 | — |
| `body-sm` | Inter | 14px | 400 | 1.5 | — |
| `body-sm-medium` | Inter | 14px | 500 | 1.5 | — |
| `caption` | Inter | 13px | 400 | 1.4 | — |
| `caption-bold` | Inter | 13px | 600 | 1.4 | — |
| `micro` | Inter | 12px | 500 | 1.4 | — |
| `micro-uppercase` | Inter | 11px | 600 | 1.4 | 1px |
| `button-md` | Inter | 14px | 500 | 1.3 | — |
| `stat-display` | PP Editorial Old | 56px | 400 | 1.1 | -1px |
| `code-md` | JetBrains Mono | 14px | 400 | 1.5 | — |
