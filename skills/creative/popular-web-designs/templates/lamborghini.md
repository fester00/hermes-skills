...
>
> The original site uses proprietary fonts. LamboType is proprietary and extremely condensed. For a free approximation use Oswald or Anton (uppercase, tight line-height).
> For self-contained HTML output, use these CDN substitutes:
> - **Primary:** `Oswald` | **Mono:** `Source Code Pro`
> - **Font stack (CSS):** `font-family: 'Oswald', system-ui, -apple-system, BlinkMacSystemFont, sans-serif;`
> - **Mono stack (CSS):** `font-family: 'Source Code Pro', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;`
> ```html
> <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@300;400;500;600;700&display=swap&family=Source+Code+Pro:wght@400;500;700&display=swap" rel="stylesheet">
> ```
